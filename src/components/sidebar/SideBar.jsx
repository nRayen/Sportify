...
const SideBar = ({ isOpen, setIsOpen }) => {
	...
	return (
		<aside
			className={`bg-bgtone p-4 flex  flex-col justify-between w-full fixed bottom-0 left-0 transition-transform duration-350 rounded-t-2xl shadow-[_0px_-5px_rgba(16,_185,_129,_0.2),_0px_-10px_rgba(16,_185,_129,_0.1),_0px_-15px_rgba(16,_185,_129,_0.05),_0px_-20px_rgba(16,_185,_129,_0.025)] lg:shadow-none lg:h-full  lg:w-[350px] lg:static lg:translate-x-0 lg:transform-none lg:duration-0 lg:rounded-none lg:border-l-[1px] dark:lg:border-white/5
